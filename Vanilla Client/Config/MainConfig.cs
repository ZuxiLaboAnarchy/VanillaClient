...
namespace Vanilla.Config
{
    public class MainConfig
    {
        ...
        public bool LogModerations
        {
            get => _LogModerations;
            set
            {
                _LogModerations = value;
                Save();
            }
        }
        ...
        public bool NameplateWallhack
        {
            get => _NameplateWallhack;
            set
            {
                _NameplateWallhack = value;
                Save();
            }
        }
        ...
        public bool NameplateMoreInfo
        {
            get => _NameplateMoreInfo;
            set
            {
                _NameplateMoreInfo = value;
                Save();
            }
        }
        ...
        public bool DetectLagOrCrash
        {
            get => _DetectLagOrCrash;
            set
            {
                _DetectLagOrCrash = value;
                Save();
            }
        }
        ...
        public bool GlobalSyncCrasher
        {
            get => _GlobalSyncCrasher;
            set
            {
                _GlobalSyncCrasher = value;
                Save();
            }
        }

        [JsonConverter(typeof(ColorConverter))]
        private Color _GlobalColors = new(1.0f, 0.8196f, 0.8627f, 1.0f);

        [JsonConverter(typeof(ColorConverter))]
        public Color GlobalColors
        {
            get => _GlobalColors;
            set
            {
        ...
        private List<string> _WhiteListedAvtID = new();

        public List<string> WhiteListedAvatarIDs
        {
            get => _WhiteListedAvtID;
            set
            {
                _WhiteListedAvtID = value;
                Save();
            }
        }

        private List<string> _WhiteListedShaderList = new();

        public List<string> WhiteListedShaderList
        {
            get => _WhiteListedShaderList;
            set
            {
                _WhiteListedShaderList = value;
                Save();
            }
        }
        ...
        public bool QuickMenuMusic
        {
            get => _QuickMenuMusic;
            set
            {
                _QuickMenuMusic = value;
                Save();
            }
        }
        ...
        public void Save()
        {
            ...
            var jsonObject = JsonConvert.SerializeObject(instance, Formatting.Indented);
