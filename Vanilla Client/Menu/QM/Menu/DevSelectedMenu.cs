...
namespace Vanilla.QM.Menu
{
    internal class DevSelectedMenu
    {
        ...
        static void SetColor(string RunRe)
        {
            ...
            InternalUIManager.RunKeyBoardPopup("Change " + RuntimeConfig.SelectedPlayer.prop_String_1 + " Tag", "Enter Color", "Done", null, RunReq, null);
            Console.WriteLine(RunRe);
        }
        static void RunReq(string RunReq)
        {
            ...
            Server.SendPostRequestInternal("upload-tag", Prams, (_, __) => Dev("TagManager", "Sent Tag Response: " + __));
