...
namespace Vanilla.Buttons.QM
{
    ...
    public class QMButtonBase
    {
        ...
        {
            button.GetComponent<VRC.UI.Elements.UiTooltip>().field_Public_String_0 = buttonToolTip;
        }
    ...
    public class QMNestedButton
    {
        ...
        public void OpenMe()
        {
            APIUtils.GetQuickMenuInstance().prop_MenuStateController_0.Method_Public_Void_String_UIContext_Boolean_EnumNPublicSealedvaNoLeRiBoIn6vUnique_0(MenuPage.field_Public_String_0);
    ...
    public class QMTabMenu
    {
        ...
        {
             MainButton.GetComponent<VRC.UI.Elements.UiTooltip>().field_Public_String_0 = newText;
        }
